            ...
            {steps.map((e) => {
                return (
                    ...
                    <li className="step" onDragStart={() => setActiveStep(e.index)} draggable>
                        {e.done ? 
                        <input id={e.num} onChange={() => doneStep({action: 'Done step', id:id, num: e.num, done: e.done})} name={e.num} type="checkbox" checked/> : <input name={e.num} type="checkbox" onChange={() => doneStep({action: 'Done step', id:id, num: e.num, done: e.done})}/>
                    }
                        {e.done ?
